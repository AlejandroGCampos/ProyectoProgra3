...
Ejemplo de colas creadas dinámicamente:
...
El uso de ACK manual garantiza que las transacciones **no se pierdan si ocurre un error durante el procesamiento**.

---

# 🔄 Flujo del Sistema

1. El Producer realiza una solicitud al endpoint:

GET /transacciones

2. La API devuelve un lote con múltiples transacciones.

3. El Producer analiza cada transacción y obtiene el campo:
